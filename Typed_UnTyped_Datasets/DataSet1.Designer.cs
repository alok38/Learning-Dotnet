...
namespace Typed_UnTyped_Datasets.DataSet1TableAdapters {
...
SELECT ID, Name, Salary, DID FROM Employees WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Typed_UnTyped_Datasets.Properties.Settings.Default.MyDatabaseConnectionString;
        }
