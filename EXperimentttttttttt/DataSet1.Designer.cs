    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.relationFK_Department = new global::System.Data.DataRelation("FK_Department", new global::System.Data.DataColumn[] {
                        this.tableDepartments.DIDColumn}, new global::System.Data.DataColumn[] {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeesRow AddEmployeesRow(string Name, decimal Salary, DepartmentsRow parentDepartmentsRowByFK_Department) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        Salary,
                        null};
                if ((parentDepartmentsRowByFK_Department != null)) {
                    columnValuesArray[3] = parentDepartmentsRowByFK_Department[0];
                }
        ...
        public partial class DepartmentsDataTable : global::System.Data.TypedTableBase<DepartmentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public DepartmentsRow AddDepartmentsRow(short DID, string DeptName) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public DepartmentsRow FindByDID(short DID) {
        ...
        public partial class EmployeesRow : global::System.Data.DataRow {
            ...
            public DepartmentsRow DepartmentsRow {
                get {
                    return ((DepartmentsRow)(this.GetParentRow(this.Table.ParentRelations["FK_Department"])));
                }
                set {
        ...
        public partial class DepartmentsRow : global::System.Data.DataRow {
            ...
            public short DID {
                get {
                    return ((short)(this[this.tableDepartments.DIDColumn]));
                }
                set {
                    this[this.tableDepartments.DIDColumn] = value;
                }
            }
            ...
            public EmployeesRow[] GetEmployeesRows() {
                if ((this.Table.ChildRelations["FK_Department"] == null)) {
                    ...
                    return ((EmployeesRow[])(base.GetChildRows(this.Table.ChildRelations["FK_Department"])));
                }
            }
        }
...
namespace EXperimentttttttttt.DataSet1TableAdapters {
...
SELECT ID, Name, Salary, DID FROM Employees WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=PRSQL;Initial Catalog=MyDatabase;User ID=labuser;Password=Welcome123$" +
                "";
        }
        ...
        public virtual int Delete(short Original_ID, string Original_Name, global::System.Nullable<decimal> Original_Salary, short Original_DID) {
        ...
        public virtual int Update(string Name, global::System.Nullable<decimal> Salary, short DID, short Original_ID, string Original_Name, global::System.Nullable<decimal> Original_Salary, short Original_DID, short ID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, global::System.Nullable<decimal> Salary, short DID, short Original_ID, string Original_Name, global::System.Nullable<decimal> Original_Salary, short Original_DID) {
    ...
    public partial class DepartmentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Departments] WHERE (([DID] = @Original_DID) AND ([DeptName] = " +
                "@Original_DeptName))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_DID", global::System.Data.SqlDbType.SmallInt, 0, global::System.Data.ParameterDirection.Input, 0, 0, "DID", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Departments] ([DID], [DeptName]) VALUES (@DID, @DeptName);\r\nSE" +
                "LECT DID, DeptName FROM Departments WHERE (DID = @DID)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@DID", global::System.Data.SqlDbType.SmallInt, 0, global::System.Data.ParameterDirection.Input, 0, 0, "DID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Departments] SET [DID] = @DID, [DeptName] = @DeptName WHERE (([DID]" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT DID, DeptName FROM dbo.Departments";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
